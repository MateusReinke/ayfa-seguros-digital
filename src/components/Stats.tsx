...
const Stats = () => {
  ...
  return (
    <section className="py-16 md:py-24 lg:py-32 bg-gradient-to-br from-muted via-background to-muted relative overflow-hidden" ref={ref}>
      ...
      <div className="absolute bottom-0 right-1/4 w-40 md:w-80 h-40 md:h-80 bg-accent/10 rounded-full blur-3xl" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-12 lg:gap-16">
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                <div className={`w-14 md:w-20 h-14 md:h-20 mx-auto mb-4 md:mb-6 rounded-xl md:rounded-2xl ${stat.color} flex items-center justify-center group-hover:${stat.glow} transition-all duration-500`}>
                  <Icon className="w-7 md:w-10 h-7 md:h-10 text-white" />
                </div>
